...
function admin() { const c=config(); return createClient(c.SUPABASE_URL,c.SUPABASE_SERVICE_ROLE_KEY,{auth:{autoRefreshToken:false,persistSession:false}}); }
function anon() { const c=config(); return createClient(c.SUPABASE_URL,c.SUPABASE_ANON_KEY,{auth:{autoRefreshToken:false,persistSession:false}}); }
