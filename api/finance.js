...
module.exports=async(req,res)=>{
  try {
    ...
    if(req.method==='GET') return send(res,200,{finance:await state(),user});
    ...
    finance.audit=[{text:`${user.name} a synchronisé les données financières`,time:'À l’instant'},...(finance.audit||[])].slice(0,100);
