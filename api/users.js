...
module.exports=async(req,res)=>{
  try {
    ...
    if(req.method==='POST'){
      const {email,password,name,role}=req.body||{};if(!name||!email||!password||!['Promoteur','Directeur','Scolarité'].includes(role))return send(res,400,{error:'Veuillez compléter correctement tous les champs.'});
